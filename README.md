...
```
  cd Capstone
  git clone https://github.com/Obimbo07/awesome-books
```
--->
...
### Deployment
 ...
 Here is a link to the live demo of the website [Click here](https://obimbo07.github.io/awesome-books/) 
...
Feel free to check the [issues page](https://github.com/Obimbo07/awesome-books/issues).
...
This project is [MIT](https://github.com/Obimbo07/awesome-books/blob/main/LICENSE) licensed.
